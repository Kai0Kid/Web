            ...
            <div className="lg:w-2/3">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-purple-400/50 transition-all duration-500">
                ...
                <p className="text-gray-300 mb-6">
                  Tôi là{" "}
                  <span className="text-purple-300">WhitePaper 白花</span>, một
                  hacker đam mê khám phá thế giới kỹ thuật số, tìm kiếm những
                  giới hạn và vượt qua chúng. Với kinh nghiệm trong lập trình,
                  bảo mật mạng, và phát triển web, tôi luôn tìm cách biến những
                  ý tưởng thành hiện thực qua từng dòng code.
                </p>
                <p className="text-gray-300 mb-6">
                  Hành trình của tôi bắt đầu từ những ngày tự học lập trình trên
                  chiếc máy tính cũ, và giờ đây tôi đang chinh phục những thử
                  thách mới trong thế giới công nghệ. Mục tiêu của tôi là chia
                  sẻ kiến thức, tạo ra những công cụ hữu ích, và truyền cảm hứng
                  cho cộng đồng hacker.
                </p>
                <p className="text-gray-300 mb-6">
                  &quot;Ad Astra Per Aspera&quot; - Qua những khó khăn để vươn
                  tới các vì sao. Tôi tin rằng không có giới hạn nào không thể
                  vượt qua, chỉ cần bạn có đủ đam mê và sự kiên trì.
                </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        Một bộ công cụ bảo mật mã nguồn mở giúp phát hiện lỗ
                        hổng trong ứng dụng web.
                      </p>
                      <a
